...
void main()
{
	...
	std::map<int, std::string> week =
	{
		...
		std::pair<int, std::string>(1, "Minday"),
	...
	{
		std::pair <std::string, std::vector<std::string>>("declatation " ,{ "декларация","обьявление","заявление"}),
		std::pair <std::string, std::vector<std::string>>("definition " ,{ "определение","формулировка","формулирования"}),
	...
	/*for (std::pair<std::string, std::vector<std::string>> i : dictionary)cout << i.first << tab << i.second << endl;*/
}